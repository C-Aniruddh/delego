...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            HttpPost httpPost = new HttpPost(Constants.WEB_SERVER + "login");
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                try {
                    ...
                    //Toast z = Toast.makeText(LoginActivity.this, responseJSON.getString("login"), Toast.LENGTH_LONG);
                    //z.show();
                ...
                try {
                    String login_status = responseJSON.getString("login");
                    ...
                    if (login_status.equals("success")) {
                        ...
                        String identifier = responseJSON.getString("login_identifier");
                        String background = responseJSON.getString("login_background");
                        ...
                        editor.putString("user_background", background);
                        editor.commit();
